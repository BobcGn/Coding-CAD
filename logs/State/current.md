...
- The project root is a Git worktree with uncommitted module-migration and documentation changes.
...
- The local pre-push gate `pnpm ci:verify` and GitHub Actions CI/CodeQL workflows are now in place.
...
- Added CI/CD documentation, GitHub Actions workflows, a PR template, and deterministic local check scripts.
