...
- Current documented gate: D-005 blocks Checkpoint 1; D-002 and D-010 block Checkpoint 2; D-009 blocks Checkpoint 3. Re-read the documents because this status may change.
...
- 当前文档门禁：D-005 阻塞 Checkpoint 1；D-002、D-010 阻塞 Checkpoint 2；D-009 阻塞 Checkpoint 3。状态可能变化，必须重新读取文档。
