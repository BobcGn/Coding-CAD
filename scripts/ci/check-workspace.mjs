...
const workspaceModules = [
  ...
  { workspace: "packages/workspace", log: "workspace", requiredScripts: ["build", "typecheck", "test", "test:unit", "clean"] },
  { workspace: "packages/architecture-review", log: "architecture-review", requiredScripts: ["build", "typecheck", "test", "test:unit", "clean"] },
  { workspace: "packages/implementation-analyzer", log: "implementation-analyzer", requiredScripts: ["build", "typecheck", "test", "test:unit", "clean"] },
  { workspace: "packages/implementation-validator", log: "implementation-validator", requiredScripts: ["build", "typecheck", "test", "test:unit", "clean"] },
